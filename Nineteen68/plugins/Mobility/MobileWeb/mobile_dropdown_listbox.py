#-------------------------------------------------------------------------------
# Name:        mobile_dropdown_listbox.py
# Purpose:
#
# Author:      rakesh.v
#
...
log = logging.getLogger('mobile_dropdown_listbox.py')
class DropdownKeywords():

    def __init__(self):
        self.radioKeywordsObj=mobile_radio_checkbox_operations.RadioCheckboxKeywords()
