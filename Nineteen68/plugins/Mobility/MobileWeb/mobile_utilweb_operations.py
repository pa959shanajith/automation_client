#-------------------------------------------------------------------------------
# Name:        mobile_utilweb_operations.py
# Purpose:
#
# Author:      sushma.p
#
...
from mobile_utils_web import Utils
...
log = logging.getLogger('mobile_utilweb_operations.py')
...
class UtilWebKeywords:
    ...
    def is_visible(self,webelement):
        ...
        try:
            ...
            flag= mobile_browser_keywords.driver_obj.execute_script(script,webelement)
    ...
    def highlight(self,webelement):
        try:
            if mobile_browser_keywords.driver_obj is not None:
                ...
                if isinstance(mobile_browser_keywords.driver_obj,webdriver.Ie):
                    mobile_browser_keywords.driver_obj.execute_script(HIGHLIGHT_SCRIPT_IE,webelement,original_style+APPLY_CSS)
                else:
                    mobile_browser_keywords.driver_obj.execute_script(HIGHLIGHT_SCRIPT,webelement,original_style+APPLY_CSS)
                ...
                if isinstance(mobile_browser_keywords.driver_obj,webdriver.Ie):
                    if '8' in browser_version:
                        mobile_browser_keywords.driver_obj.execute_script(HIGHLIGHT_SCRIPT_IE,webelement,original_style+REMOVE_CSS_IE8)
                    else:
                        mobile_browser_keywords.driver_obj.execute_script(HIGHLIGHT_SCRIPT_IE,webelement,original_style)
                else:
                    mobile_browser_keywords.driver_obj.execute_script(HIGHLIGHT_SCRIPT,webelement,original_style)
        except Exception as e:
            err_msg=self.__web_driver_exception(e)
    ...
    def __setfocus(self,webelement):
        status=TEST_RESULT_FAIL
        if mobile_browser_keywords.driver_obj is not None:
            mobile_browser_keywords.driver_obj.execute_script(FOUCS_ELE,webelement)
            status=TEST_RESULT_PASS
        return status
    ...
    def mouse_hover(self,webelement,*args):
        ...
        try:
            if webelement is not None:
                ...
                if isinstance(mobile_browser_keywords.driver_obj,webdriver.Firefox):
                    yoffset=mobile_browser_keywords.driver_obj.execute_script(MOUSE_HOVER_FF)
    ...
    def tab(self,webelement,*args):
        ...
        try:
            ...
            if isinstance(mobile_browser_keywords.driver_obj,webdriver.Chrome):
        ...
        try:
            if webelement is not None:
                if webelement.is_enabled():
                    ...
                    action_obj=ActionChains(mobile_browser_keywords.driver_obj)
    ...
    def switch_to_window(self,webelement,input,*args):
        ...
        try:
            ...
            if not(input is None or int(input) <0):
                ...
                cur_handle=mobile_browser_keywords.driver_obj.current_window_handle
                from_window=-1
                ...
                if from_window>-1:
                    mobile_browser_keywords.driver_obj.switch_to.window(window_handles[to_window-1])
                    logger.print_on_console('Switched to window handle'+mobile_browser_keywords.driver_obj.current_window_handle)
            ...
            try:
                if isinstance(etype,NoSuchWindowException):
                    ...
                    if len(window_handles)>0:
                        ...
                        mobile_browser_keywords.driver_obj.switch_to.window(window_handles[total_handles-1])
                        status=TEST_RESULT_PASS
                        methodoutput=TEST_RESULT_TRUE
                    else:
        ...
        try:
            if webelement !=None:
                ...
                if not(input is None ):
                    row_num=int(input[0])
                    col_num=int(input[1])
                    mobile_table_keywords_obj=mobile_table_keywords.TableOperationKeywords()
                    actual_xpath=mobile_table_keywords_obj.getElemntXpath(webelement)
                    element = mobile_browser_keywords.driver_obj.find_element_by_xpath(actual_xpath)
                    cell=mobile_table_keywords_obj.javascriptExecutor(element,row_num-1,col_num-1)
                    ...
                    if isinstance(mobile_browser_keywords.driver_obj,webdriver.Firefox):
                        ...
                        value=mobile_browser_keywords.driver_obj.execute_script(javascript)
                        offset=int(value)
                        robot=pyrobot.Robot()
    ...
    def __get_window_handles(self):
        window_handles=mobile_browser_keywords.driver_obj.window_handles
        window_handles=mobile_browser_keywords.driver_obj.window_handles
