...
class InstallAndLaunch():
     ...
     def installApplication(self, apk_path, platform_version, device_name, udid,platfrom_name = "", *args):
        self.driver=None
...
##        jsonArray['mirror']='IMAGEEEEE'
        jsonArray['mirror']=driver.get_screenshot_as_base64() #send base64 string send  height
        dimension = driver.get_window_size()
        jsonArray['mirrorwidth'] = dimension['width']
        jsonArray['mirrorheight'] = dimension['height']
        # send base64 string send  height
