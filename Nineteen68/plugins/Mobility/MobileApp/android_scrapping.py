...
##            file_path = 'D:\\mobile_python\\node_modules\\appium\\build\\lib\\main.js'
            ...
            print e
            print('Exception in starting server')
     ...
     def stop_server(self):
            try:
                ...
                print e
                print('Exception in stopping server')
     ...
     def installApplication(self,apk_path,platform_version,device_name,*args):
        ...
        try:
            ...
            print e
            print "Not able to install or launch application"
    ...
    def xmltojson(self,driver):
        ...
        for i in range(len(XpathList)):
            ...
            ScrapeList.append({'xpath': xpath, 'tag': class_name[i],
                                                    ...
                                                    'reference': str(uuid.uuid4()),'enabled':enabled[i],'rectangle':bounds})
        self.save_json(ScrapeList,driver)
