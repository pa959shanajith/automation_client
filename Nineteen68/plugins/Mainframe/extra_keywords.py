#-------------------------------------------------------------------------------
# Name:        extra_keywords.py
# Purpose:     Seperate class to perform automation on Extra Emulator
#
...
import logger
import logging
log = logging.getLogger('extra_keywords.py')

class ExtraKeywords:

    def __init__(self):
        """The instantiation operation __init__ creates an empty object of the class ExtraKeywords
