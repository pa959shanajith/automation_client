...
##            self.reporting_obj.generate_report_step(tsp,self.status,tsp.name+' EXECUTED and the result is  '+self.status,ellapsed_time,keyword_flag,result[3])
            self.reporting_obj.generate_report_step(tsp,self.status,self,self.status,ellapsed_time,keyword_flag,result[3])
...
##            print '\n'
    ...
    def get_all_the_imports(self,plugin_path):
        ...
        os.chdir('..')
        curdir = os.getcwd()
        path= 'D://git//Nineteen68_UI' + '//Nineteen68//plugins//'+plugin_path
...
##            condition_check=False
            ...
            if not (do_not_execute) :
                ...
                for browser in browser_type[suite_id]:
                    ...
                    for scenario,scenario_id,condition_check in zip(suite_id_data,scenarioIds[suite_id],condition_check[suite_id]):
...
##    json_data={u'executionId': u'b4b6766a-08b3-4746-a169-260dd13f655b', u'suitedetails': [{u'13bbacaf-82c7-4c4a-9f91-0933462b10d4': [{u'72bcc08e-15a7-4de6-ad59-389aee2230cb': u'[{"template":"","testcase":"[]","testcasename":"Dev_Testing"}]'}], u'dataparampath': [u'http://10.41.31.92:3000/execute'], u'browserType': [u'1', u'3'], u'condition': [None], u'scenarioIds': [u'72bcc08e-15a7-4de6-ad59-389aee2230cb']}], u'testsuiteIds': [u'13bbacaf-82c7-4c4a-9f91-0933462b10d4']}
