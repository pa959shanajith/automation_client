...
##        data = {'view' : vie}
        ...
        with open('domelements.json', 'w') as outfile:
                logger.log('FILE: fullscrape.py , DEF: save_json_data() , MSG: Opening domelements.json file to write vie object')
                json.dump(data, outfile, indent=4, sort_keys=False)
                logger.log('FILE: fullscrape.py , DEF: save_json_data() , MSG: vie is dumped into  domelements.json file ')
        outfile.close()
        return data
