        ...
        if webelement is not None:
            ...
            if not err_msg and webelement.is_enabled():                
                if (self.util.is_visible(webelement)):
                    local_cbo.log.debug('element is visible, performing selenium code')
                    try:
                            ...
                            if len(index.strip()) != 0:
                                ...
                                if (input_val < optionListSize):
                                    for i in range(0, optionListSize):
                                        if (input_val == i):
                                            if (self.util.is_visible(optionList[input_val])):
                        ...
                        local_cbo.log.info(ERROR_CODE_DICT['MSG_OBJECT_NOT_DISPLAYED'])
                            ...
                            if (inp_val is not None):
                                if len(inp_val.strip()) != 0:
                                    ...
                                    if len(data_list) > 0:
                                        ...
                                        err_msg = ERROR_CODE_DICT['ERR_INVALID_INPUT']
                                    if (flag):
                                        if (self.util.is_visible(optionList[i])):                                          
