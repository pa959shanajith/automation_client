...
CLICK_JAVASCRIPT = """ 
    async function click_b(element){
        if (document.createEvent) {
            var result = {

            }     
            result['evType'] = 'Click executed through part-1';
            result['result'] = 'None'     
            var evt = document.createEvent('MouseEvents');                   
            evt.initMouseEvent('click', true, true, window, 0, 0, 0, 0, 0, false, false, false, false, 0, null);   	
            await setTimeout(async function() {     	
                result['result'] = await element.dispatchEvent(evt);
                return result;
            }, 100); 
        }else {
    ...
    var result = await click_b(element);
    callback(result);
    return result;
     """
...
CUSTOM_JS="""var eleCollection=document.getElementsByTagName("*"),startIndex=arguments[1],eleType=arguments[2];eleType=eleType.toLowerCase();var localIndex,eleVisibleText=arguments[3],eleIndex=arguments[4],result=[],result0="null",result1="null",result2=localIndex=arguments[5],result3=eleCollection.length,result4="null",col=[];col.submit="button",col.reset="button",col.button="button",col.file="button",col.image="img",col.search="text",col.number="text",col.url="text",col.email="text",col.tel="text",col.textarea="text",col.password="text";var listFlag=!1,dropdown=!1;"listbox"==eleType?listFlag=!0:"dropdown"==eleType&&(dropdown=!0),window.Element&&window.Element.prototype&&window.Element.prototype.hasAttribute||function(){function e(e){return void 0!==this[e]}for(var t=document.getElementsByTagName("input"),l=0;l<t.length;l++)t[l].hasAttribute=e}();var sisVisible=function(){return function(e){if(document.hidden||0==e.offsetWidth||0==e.offsetHeight||"hidden"==e.style.visibility||"none"==e.style.display||0===e.style.opacity)return!1;e.getBoundingClientRect();if(window.getComputedStyle||e.currentStyle)for(var t=e,l=null;t&&t!==document;){if(!t.parentNode)return!1;if((l=window.getComputedStyle?window.getComputedStyle(t,null):t.currentStyle)&&("hidden"==l.visibility||"none"==l.display||void 0!==l.opacity&&!(l.opacity>0)))return!1;t=t.parentNode}return!0}}();function stext_content(e,t){var l="",o="";null!=e.getAttribute("alt")&&(o=o.concat(e.getAttribute("alt")," ")),null!=e.getAttribute("title")&&(o=o.concat(e.getAttribute("title")," ")),null!=e.getAttribute("value")&&(o=o.concat(e.getAttribute("value")," ")),null!=e.getAttribute("placeholder")&&(o=o.concat(e.getAttribute("placeholder")," ")),"dropdown"!=t&&"listbox"!=t||(o=o.concat(e.textContent," "));for(var i=0;i<e.childNodes.length;i++){var n=e.childNodes[i];swhitespace=/^\s*$/,"#text"!==n.nodeName||swhitespace.test(n.nodeValue)||(l+=n.nodeValue)}return l=o.concat(l)}function findelement(e){for(i=startIndex;i<eleCollection.length;i++)if(sisVisible(eleCollection[i]))if(eleCollection[i].tagName.toLowerCase()==e&&" text "!=eleCollection[i].tagName.toLowerCase()||col[eleCollection[i].tagName.toLowerCase()]==e||dropdown&&"select"==eleCollection[i].tagName.toLowerCase()&&!eleCollection[i].hasAttribute("multiple")||listFlag&&"select"==eleCollection[i].tagName.toLowerCase()&&eleCollection[i].hasAttribute("multiple")){if(stext_content(eleCollection[i],e.toLowerCase()).indexOf(eleVisibleText)>=0){if(localIndex==eleIndex){result0="found",result1="null",result2=localIndex,result3=i+1,result4=eleCollection[i];break}localIndex+=1}}else if("input"!=eleCollection[i].tagName.toLowerCase()||!eleCollection[i].hasAttribute("type")||eleCollection[i].getAttribute("type").toLowerCase()!=e&&col[eleCollection[i].getAttribute("type").toLowerCase()]!=e){if("input"==eleCollection[i].tagName.toLowerCase()&&eleCollection[i].type.toLowerCase()==e){if(stext_content(eleCollection[i],e.toLowerCase()).indexOf(eleVisibleText)>=0){if(localIndex==eleIndex){result0="found",result1="null",result2=localIndex,result3=i+1,result4=eleCollection[i];break}localIndex+=1}}else if("iframe"==eleCollection[i].tagName.toLowerCase()||"frame"==eleCollection[i].tagName.toLowerCase()){result0="stf",result1=eleCollection[i],result2=localIndex,result3=i+1,result4="null";break}}else if(stext_content(eleCollection[i],e.toLowerCase()).indexOf(eleVisibleText)>=0){if(localIndex==eleIndex){result0="found",result1="null",result2=localIndex,result3=i+1,result4=eleCollection[i];break}localIndex+=1}}findelement(eleType),result[0]=result0,result[1]=result1,result[2]=result2,result[3]=result3,result[4]=result4;return result;"""
